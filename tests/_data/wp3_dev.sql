...
INSERT INTO `course` (`id`, `team`, `subject_id`, `instructor_id`, `semester_id`, `created_by`, `updated_by`) VALUES
(3, 'A', 1, 1, 1, 1, 1);
...
INSERT INTO `instructor` (`id`, `name`, `email`, `phone`, `created_by`, `updated_by`) VALUES
(1, 'Balla Tamás', 'nomail@uni-eszterhazy.hu', '+36 30 123 6547', 1, 1);
...
('m000000_000000_base', 1557776235),
('m140506_102106_rbac_init', 1557776307),
('m170907_052038_rbac_add_index_on_auth_assignment_user_id', 1557776307),
('m180523_151638_rbac_updates_indexes_without_prefix', 1557776307),
('m190513_194142_init_rbac', 1557776957);
...
INSERT INTO `scedule` (`title`, `description`, `deadline`, `course_id`, `created_by`, `updated_by`) VALUES
('Konzultáció', 'Lorem…', '2019-02-23 00:00:00', 3, 1, 1),
('Beadandó feladat', 'Lorem ipsum delor sit…', '2019-04-28 00:00:00', 3, 1, 1),
('1. ZH', 'Lorem ipsum delor…', '2019-05-10 00:00:00', 3, 1, 1);
...
INSERT INTO `semester` (`id`, `semester`, `created_by`, `updated_by`) VALUES
(1, '2018-19/2', 1, 1);
...
INSERT INTO `subject` (`id`, `title`, `code`, `description`, `created_by`, `updated_by`) VALUES
(1, 'Webprogramozás III. gy.', 'LBT_IM744G2', 'Webfejlesztés PHP keretrendszerek segítségével.', 1, 1),
(2, 'Magasszintű programozási nyelvek II. gy.', 'LBT_IM744G1', 'Programozás oktatás C# objektumorientált környezetben.', 1, 1);
...
ALTER TABLE `file`
  ...
  ADD CONSTRAINT `fk_file_user1` FOREIGN KEY (`created_by`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_file_user2` FOREIGN KEY (`updated_by`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
